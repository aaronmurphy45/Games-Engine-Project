...
public class MovingCrateGeneration : MonoBehaviour {
    ...
    // This script is used to procedurally generate the Moving Boxes.

        private void Update() {
            // The length of each terrain is 256. 
            // As the ball moves forward, the moving crate will be generated in a random position in bewteen that multiple of the length of the terrain.
